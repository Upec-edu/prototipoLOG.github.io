document.addEventListener('DOMContentLoaded', () => {
    ...
    const infoMessages = {
        n: "CASILLA N°. El transportista autorizado indicará el número de identificación que le asigna a la CPIC, el que estará conformado de la siguiente manera: a) Por las letras del código bilítero ISO Alfa-2 correspondiente al país de origen de la operación de transporte internacional (BO-Bolivia, CO-Colombia, EC-Ecuador, PE-Perú, VE-Venezuela); b) Permiso Originario; y, c) Seis dígitos numéricos que señalan la numeración correlativa ascendente y que corresponde a la CPIC emitida por el transportista autorizado; y, d) Por los dos últimos dígitos del año de emisión de la Carta de Porte Internacional por Carretera.",
        1: "CASILLA 1. Se individualizará al transportista que emite la CPIC, indicando la denominación o razón social de la empresa, la dirección de su oficina matriz con indicación de la ciudad y país respectivos. A esta información deberá agregarse el logotipo y/o nombre comercial de la empresa.",
        ...
        5: "CASILLA 5. Se individualizará a la persona o agente que debe ser notificado de la llegada de las mercancías. Se señalará su dirección con indicación de la ciudad y país respectivos y, en lo posible, su número de teléfono, télex o fax.",
        ...
        9: "CASILLA 9. Se indicará, según corresponda, una de las siguientes formas de operación en que se llevará a cabo el transporte internacional de mercancías por carretera:a) Directo, sin cambio del camión o tractocamión y del remolque o semirremolque; o, b) Directo, con cambio del tractocamión, sin transbordo de las mercancías.El transbordo de las mercancías se efectuará sólo cuando lo acuerden expresa-mente el transportista autorizado y el remitente, lo cual deberá constar en la CPIC. Asimismo, se especificará la forma en que se realizará el pago, indicando el lugar y el tiempo en que se efectuará el mismo.",
        ...
        16: "CASILLA 16. Se indicará el precio que tienen las mercancías al tiempo y lugar en que el transportista autorizado las recibió, según el artículo 92 de la Decisión 399, o se hizo cargo de ellas, conforme a los términos de compra-venta internacionales de INCOTERMS, acordados entre las partes, así como el tipo de moneda en que se exprese su precio (*).",
